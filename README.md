...
![Dashboard Chatbot FAQ](p1_chatbot_faq/outputs/dashboard_p1_chatbot.png)
...
![Dashboard Contestadora](p2_contestadora_soporte/outputs/dashboard_p2_contestadora.png)
...
![Dashboard KPI Ventas](p3_dashboard_ventas/outputs/dashboard_p3_ventas.png)
...
Meta, Google Ads y email marketing para armar reportes manuales. Los account managers respondian
las mismas preguntas de clientes repetidamente sin tener los datos a mano.
...
![Dashboard Marketing](p4_asistente_marketing/outputs/dashboard_p4_marketing.png)
...
en que horarios se saturaba el sistema, ni que porcentaje podia resolverse antes de llegar al agente.
...
![Dashboard Call Center](p5_callcenter_analytics/outputs/dashboard_p5_callcenter.png)
...
git clone https://github.com/juanestebanagudelo/ai-portfolio-freelance.git
...
python p2_contestadora_soporte/demo.py
python p3_dashboard_ventas/demo.py
python p4_asistente_marketing/demo.py
python p5_callcenter_analytics/demo.py
```

> **Sin API key:** todos los proyectos funcionan en modo demo con respuestas simuladas realistas.
> No necesitas gastar nada para ver el flujo completo.
...
├── src/             # Logica de negocio, motor AI, visualizacion
├── outputs/         # Dashboards PNG generados por el codigo
├── demo.py          # Script de demo ejecutable
